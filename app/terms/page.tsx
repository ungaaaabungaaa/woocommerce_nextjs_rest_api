...
const TermsAndConditions = () => {
  return (
    <div className="terms-and-conditions overflow-hidden text-white dark:text-black">
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section>
          ...
          <p>
            ...
            through our website is accurate and up-to-date.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We make every effort to ensure that the products and services
            offered on our website are available as described. However, we do
            not guarantee the availability of all items at all times.
          </p>
          <p>
            We reserve the right to withdraw or modify any product or service
            offered on the website without prior notice.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            subject to change without notice. The final price of your order will
            be confirmed at the checkout page before you make a payment.
          </p>
          <p>
            Payment must be made in full before the processing and shipment of
            any orders.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            images, graphics, logos, and software, is the property of [Your
            Company Name] or its licensors and is protected by copyright and
            intellectual property laws.
          </p>
          <p>
            You may not copy, modify, or distribute any content from the website
        ...
        <section>
          ...
          <p>
            We will not be held liable for any indirect, special, incidental, or
            consequential damages arising from the use of our website or
            services.
          </p>
          <p>
            We are not responsible for any loss of data, business interruption,
            or other damages resulting from your use of our website.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            damages arising out of your violation of these terms.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            responsible for the content, privacy practices, or actions of these
            third-party sites.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            website at our discretion, without notice, for violation of these
