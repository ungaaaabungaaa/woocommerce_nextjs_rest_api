      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section>
          ...
          <p>
            ...
            data when you visit our site, make a purchase, or interact with us
            in other ways.
          </p>
          <p>
        ...
        <section>
          ...
          <ul className="list-inside list-disc">
            ...
            <li>
              Payment details such as credit card information or other payment
              methods
            </li>
            <li>
            ...
            <li>
              Cookies and tracking technologies that help us personalize your
              experience
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-inside list-disc">
            ...
            <li>
              To improve the functionality of our website and enhance your
              shopping experience
            </li>
            <li>
              To send you promotional emails or newsletters, if you have
              opted-in
            </li>
        ...
        <section>
          ...
          <p>
            ...
            confidential and use it solely for the purposes specified by us.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            destruction. These include encryption, firewalls, and secure
        ...
        <section>
          ...
          <ul className="list-inside list-disc">
            ...
            <li>
              Withdraw your consent for processing at any time, where applicable
            </li>
          </ul>
          <p>
        ...
        <section>
          ...
          <p>
            You can manage your cookie settings through your browser at any
            time. If you disable cookies, some features of the website may not
            function properly.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            data, please contact us at [your contact email].
          </p>
        </section>
        <br></br>
      </div>
